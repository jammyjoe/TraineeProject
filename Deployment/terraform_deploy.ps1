...
terraform import azurerm_key_vault_secret.example "https://pokedex-kv.vault.azure.net/secrets/DefaultConnection/736288c5e47249b8acd86289ca454a4b"
terraform import azurerm_key_vault_secret.example "https://pokedex-kv.vault.azure.net/secrets/PokedexDatabase--AdminPassword/a85f3168ddb84f99bda51d66cdbe53b0"
terraform import azurerm_key_vault_secret.example "https://pokedex-kv.vault.azure.net/secrets/StorageAccountConnection/7880efa50416481eb46fd12f52d08bbc"
